let answer = ["яблоко", "груша", "город", "школа", "сайт", "браузер", "плагін", "цвет", "стиль", "язик", "сорока"];
...
$(document).ready(function () {
    ...
    $("#btnTask1").click(function(){
        if ($("#inputTask1").val().toLowerCase() == `${answer[num-1]}`){
            alertify.success("відповідь правільна");
            $("inputTask2").val("");
            progress++;
            ...
            alertify.error("НЕПРАВЕЛЬНО ПОРОБУЙ ЕЩЕ РАЗ!!!");
        }
    });
});
